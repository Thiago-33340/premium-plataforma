...
-- ===== Ajuste 3: oregano 0,75g na bolinha com oregano; rolinho = UNIDADE =====
UPDATE est_producao_receita SET quantidade_por_unidade=0.75, unidade='g' WHERE tenant_id='khardela:premiumpizzas:sjrp' AND produto_id=(SELECT id FROM est_produto WHERE tenant_id='khardela:premiumpizzas:sjrp' AND nome='Bolinha de muçarela com orégano') AND insumo_produto_id=(SELECT id FROM est_produto WHERE tenant_id='khardela:premiumpizzas:sjrp' AND nome='Orégano');
UPDATE est_produto SET unidade='UNIDADE' WHERE tenant_id='khardela:premiumpizzas:sjrp' AND nome='Rolinho de muçarela';
UPDATE est_produto SET unidade='UNIDADE' WHERE tenant_id='khardela:premiumpizzas:sjrp' AND nome='Rolinho de presunto e muçarela';

-- ===== Ajuste 4: rolinhos (fatia muçarela=27g, presunto=24g) =====
